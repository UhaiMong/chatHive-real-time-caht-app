export const WelcomeScreen = () => (
  <section className="relative h-full min-h-0 bg-[url('chatWindowbg.jpg')] bg-fixed bg-cover bg-center">
    {/* overlay */}
    <div className="absolute z-0 bg-linear-to-b from-black/90 to-transparent inset-0" />
    <div className="relative z-20 h-full text-gray-50 flex-1 flex flex-col items-center justify-center gap-4 text-center px-8">
